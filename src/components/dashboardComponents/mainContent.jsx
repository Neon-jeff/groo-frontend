    ...
    <div className=" w-7/12 px-10 py-6 max-sm:px-5 max-sm:w-full mt-20 ">
      ...
      <div className="flex flex-col gap-5">
        ...
        <div className="bg-white p-5 rounded-md flex justify-between text-sm max-sm:grid max-sm:grid-cols-2 max-sm:gap-5 ">
          ...
          <p className="flex flex-col gap-1 p-5 justify-center rounded-lg shadow-md bg-purple-50">
            Monthly Payment{" "}
            <span className="text-md font-semibold text-purple-600">$3000</span>
          </p>
          <p className="flex flex-col gap-1 justify-center p-5 rounded-lg shadow-md bg-yellow-50">
            Duration{" "}
            <span className="text-md font-semibold text-yellow-600">19months</span>
          </p>
          <p className="flex flex-col gap-1 p-5 justify-center rounded-lg shadow-md bg-green-50">
            Expected Income{" "}
