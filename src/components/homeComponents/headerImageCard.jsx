...
export default function HeaderImageCard({position}) {
  return (
    ...
    >
      ...
      <div className="bg-yellow-50 text-[.75rem] p-5 h-full border-2 border-black  -translate-x-2 -translate-y-2 flex items-center justify-center  rounded-md font-medium">
