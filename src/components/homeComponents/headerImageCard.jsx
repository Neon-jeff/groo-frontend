...
export default function HeaderImageCard({position}) {
  return (
    ...
    >
      <div className="absolute bg-saltpan-900 border-[2px] border-black w-full h-full rounded-md"></div>
      <div className="bg-white text-[.75rem] p-5 h-full border-[2px] border-black  -translate-x-2 -translate-y-2 flex items-center justify-center  rounded-md font-medium">
