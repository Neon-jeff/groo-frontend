...
export default function Problems() {
  return (
    <div className="bg-yellow-50 border-t-2 border-b-2 border-black flex w-full flex-row-reverse py-20 items-center justify-center max-sm:flex-col max-sm:gap-10 px-5  ">
