...
export default function FeatureCard({text}) {
  return (
    ...
    >
      ...
      <div className="bg-fill text-lg w-full p-5 h-full border-[1px] border-black  translate-x-2 -translate-y-2 flex items-center justify-center  rounded-md font-medium">
        {text}
      </div>
    </div>
  );
