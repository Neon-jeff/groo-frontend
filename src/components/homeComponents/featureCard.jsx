...
export default function FeatureCard({text}) {
  return (
    ...
    >
      ...
      <div className="bg-gray-50 text-[.9rem] w-full p-5 h-full border-2 border-black  translate-x-2 -translate-y-2 flex items-center justify-center  rounded-md font-medium">
        {text}
      </div>
    </div>
  );
