...
export default function ProblemCard({text}) {
  return (
    ...
    >
      ...
      <div className="bg-fill text-md w-full p-5 h-full border-[1px] border-black  translate-x-2 -translate-y-2 flex items-center justify-center  rounded-2xl font-medium">
       {text}
      </div>
    </div>
  );
