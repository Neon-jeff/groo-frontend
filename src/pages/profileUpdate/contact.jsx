  ...
  return (
    <div className=" flex flex-col gap-10 items-center justify-center text-sm pb-10 bg-[#f8f9fa] ">
      ...
      <div className="flex w-full justify-center max-sm:px-5 gap-10 max-sm:mt-5 ">
        ...
        >
          <FieldSet label={"Phone"} type={"tel"} name={"phone"} state={phone} setState={setPhone} />
          <FieldSet label={"Address Line"} type={"text"} name={"address"} state={address} setState={setaddress} />
          <FieldSet label={"State"} type={"text"} name={"text"} state={state} setState={setstate} />
          <FieldSet label={"Zip Code"} type={"text"} name={"text"} state={zip} setState={setZip} />
      <div></div>
          <button
            onClick={()=>{
